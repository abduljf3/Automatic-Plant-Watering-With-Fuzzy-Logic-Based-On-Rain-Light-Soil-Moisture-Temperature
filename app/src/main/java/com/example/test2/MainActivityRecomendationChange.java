...
public class MainActivityRecomendationChange extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            ...
            if (itemId == R.id.navigation_home) {
                ...
                Intent infoIntent = new Intent(MainActivityRecomendationChange.this, InfoActivity.class);
                startActivity(infoIntent);
                return true;
            } else if (itemId == R.id.navigation_analytics) {
                Intent aboutMeIntent = new Intent(MainActivityRecomendationChange.this, AboutMeActivity.class);
    ...
    public class PlantRecommendation {
        ...
        public PlantRecommendation(String name, String imageUrl) {
            this.name = name;
    ...
    private void updateRecommendations(Long humidity) {
        ...
        recommendationTimer.scheduleAtFixedRate(new TimerTask() {
            @Override
            public void run() {
                runOnUiThread(() -> {
