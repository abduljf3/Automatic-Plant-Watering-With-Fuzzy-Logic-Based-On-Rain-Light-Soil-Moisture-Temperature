...
public class MainActivitybackupudhbisabackgroud extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        L1StatusRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                tvL1DataView.setText(snapshot.getValue(String.class));
            }
        ...
        L2StatusRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                tvL2DataView.setText(snapshot.getValue(String.class));
                toggleL2.setChecked("0".equals(snapshot.getValue(String.class)));
            }
        ...
        L3StatusRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                tvL3DataView.setText(snapshot.getValue(String.class));
                toggleL3.setChecked("0".equals(snapshot.getValue(String.class)));
            }
